...
SRCS_DIR = srcs/
SRCS = Request.cpp Response.cpp CGI_Handler.cpp ListeningSocket.cpp main.cpp ClientSocket.cpp Logger.cpp Webserv_machine.cpp ASocket.cpp Server.cpp Location.cpp ConfigParser.cpp utils.cpp
