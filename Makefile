...
SRCS_DIR = srcs/
SRCS = Request.cpp ListeningSocket.cpp CGI_Handler.cpp main.cpp ClientSocket.cpp Logger.cpp Webserv_machine.cpp ASocket.cpp Server.cpp Location.cpp ConfigParser.cpp utils.cpp
